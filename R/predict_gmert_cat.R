...
#'   (default: \code{"id"}).
#' @param type Character. Type of prediction. One of \code{"class"},
#'   \code{"prob"}, or \code{"eta"}.
#'
#' @return
#' If \code{type = "class"}, returns a vector of predicted classes.
#' If \code{type = "prob"}, returns an \eqn{N \times K} matrix of predicted
#' class probabilities.
#' If \code{type = "eta"}, returns an \eqn{N \times (K-1)} matrix of predicted
#' linear predictors for the non-reference classes.
#'
#' @family gmert
#'
#' @export
